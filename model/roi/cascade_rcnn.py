...
from .faster_rcnn import FastRCNNOutputLayers, fast_rcnn_inference
from .roi_head import StandardROIHeads
...
class CascadeROIHeads(StandardROIHeads):
    ...
    def _forward_box(self, features, proposals, targets=None):
        ...
        Args:
            ...
            proposals (list[Instances])
                Each has fields "proposal_boxes", and "objectness_logits", "gt_classes", "gt_boxes".
        """
    ...
    def _run_stage(self, features, proposals, stage):
        ...
        # scale down the gradients on features to averages the losses among heads.
        # ↓ It's not necessary. You can skip it if you don't understand. ↓
